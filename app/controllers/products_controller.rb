class ProductsController < Application::Base
  ...
  def create
    ...
    respond_to do |format|
      if @product.save
        format.html { redirect_to new_company_product_path, notice: 'Product was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @product.update(product_params)
        format.html { redirect_to [@selected_company, @product], notice: 'Product was successfully updated.' }
      else
  ...
  def destroy
    @product.destroy
    respond_to do |format|
      format.html { redirect_to company_product_path, notice: 'Product was successfully destroyed.' }
    end
  end
